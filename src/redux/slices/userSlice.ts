...
export const fetchLogin = createAsyncThunk("user/login", async (user: { username: string; password: string }, thunkApi) => {
  try {
    const res = await fetch(`https://serverfinaltest-1.onrender.com/api/users/login`, {
      method: "post",
      headers: {
...
export const fetchRegister = createAsyncThunk("user/register", async (user: { username: string; password: string; organization: string; area: string }, thunkApi) => {
  try {
    const res = await fetch(`https://serverfinaltest-1.onrender.com/api/users/register`, {
      method: "post",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    const resAttacks = await fetch(`https://serverfinaltest-1.onrender.com/api/attack/${data.area}`, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${data.token}`,
...
export const fetchGetWepones = createAsyncThunk("user/attack", async (_, thunkApi) => {
  try {
    ...
    const res = await fetch(`https://serverfinaltest-1.onrender.com/api/attack/wepones`, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        Authorization: token,
...
export const fetchGetActionsAtacker = createAsyncThunk(
  ...
  try {
    ...
    const resAttacks = await fetch(`https://serverfinaltest-1.onrender.com/api/attack/attacks`, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        Authorization: token,
...
export const fetchGetActionsDefencer = createAsyncThunk(
  ...
  try {
    ...
    const resAttacks = await fetch(`https://serverfinaltest-1.onrender.com/api/attack/${area}`, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        Authorization: token,
...
export const fetchLaunch = createAsyncThunk("user/attack/lunch", async (attack: { wepone: string; area: string }, thunkApi) => {
  try {
    ...
    const res = await fetch(`https://serverfinaltest-1.onrender.com/api/attack`, {
      method: "post",
      headers: {
        "Content-Type": "application/json",
        Authorization: token, 
...
export const fetchIntersepted = createAsyncThunk("user/defence/lunch/ewre", async (attack: { wepone: string; attackID: string }, thunkApi) => {
  try {
    ...
    const res = await fetch(`https://serverfinaltest-1.onrender.com/api/attack/defence`, {
      method: "post",
      headers: {
        "Content-Type": "application/json",
        Authorization: token,
